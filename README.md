...
- rules/: nine distilled Bridge rulebooks (in_finetune /
  out_of_finetune / in_and_out_of_finetune evidence, three draws each)
  and the three LIBERO rulebooks reported in the paper
